...
export default function LatestNewsComponent() {
  ...
  <div className="mb-12 text-left md:text-center">
    <h2 className="mb-2 text-3xl font-extrabold leading-tight text-yellow-400">Skcript Blog</h2>
  ...
  <div className="flex flex-col space-y-12 divide-y divide-gray-200">
    <div>
      ...
      <h2 className="mb-2 text-xl font-extrabold leading-snug tracking-tight text-yellow-200 md:text-3xl">
        <a href="#" className="text-yellow-400 hover:text-purple-700">Process Documents Using Artificial Intelligence For RPA Bots</a>
      </h2>
    ...
    <div>
      <p className="pt-12 mb-3 text-sm font-normal text-gray-500">April 16, 2020</p>
      <h2 className="mb-2 text-xl font-extrabold leading-snug tracking-tight text-yellow-200 md:text-3xl">
        <a href="#" className="text-yellow-400 hover:text-purple-700">Implement Dark Mode in Your Android App</a>
      </h2>
      <p className="mb-4 text-base font-normal text-gray-300">
    ...
    <div>
      <p className="pt-12 mb-3 text-sm font-normal text-gray-500">April 16, 2020</p>
      <h2 className="mb-2 text-xl font-extrabold leading-snug tracking-tight text-yellow-200 md:text-3xl">
        <a href="#" className="text-yellow-400 hover:text-purple-700">Why is Mental Health one of the Important Issues to Address?</a>
      </h2>
      <p className="mb-4 text-base font-normal text-gray-300">
    ...
    <div>
      <p className="pt-12 mb-3 text-sm font-normal text-gray-500">April 16, 2020</p>
      <h2 className="mb-2 text-xl font-extrabold leading-snug tracking-tight text-yellow-200 md:text-3xl">
        <a href="#" className="text-yellow-400 hover:text-purple-700">Pattern Matching In Elixir</a>
      </h2>
      <p className="mb-4 text-base font-normal text-gray-300">
    ...
    <div>
      <p className="pt-12 mb-3 text-sm font-normal text-gray-500">April 16, 2020</p>
      <h2 className="mb-2 text-xl font-extrabold leading-snug tracking-tight text-yellow-200 md:text-3xl">
        <a href="#" className="text-yellow-400 hover:text-purple-700">3 things you should change during your focus group interview</a>
      </h2>
    ...
    <div>
      <p className="pt-12 mb-3 text-sm font-normal text-gray-500">April 16, 2020</p>
      <h2 className="mb-2 text-xl font-extrabold leading-snug tracking-tight text-yellow-200 md:text-3xl">
        <a href="#" className="text-yellow-400 hover:text-purple-700">Using Webpack with React Typescript</a>
      </h2>
      <p className="mb-4 text-base font-normal text-gray-300">
